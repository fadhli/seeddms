...
class SeedDMS_Bootstrap_Style extends SeedDMS_View_Common {
	...
	function htmlStartPage($title="", $bodyClass="") { /* {{{ */
		...
		echo "<link href='http://fonts.googleapis.com/css?family=Roboto+Slab:400,300,700' rel='stylesheet' type='text/css'>";
...
<?php
	...
	function globalBanner() { /* {{{ */
		echo "<div class=\"navbar navbar-fixed-top\" style=\"border-top: 2px solid #196da3\">\n";
		echo " <div class=\"navbar-inner\">\n";
		echo "  <div class=\"container-fluid\">\n";
		echo "   <a class=\"brand\" href=\"../out/out.ViewFolder.php?folderid=".$this->params['rootfolderid']."\">".(strlen($this->params['sitename'])>0 ? '<img src="/../styles/logo.jpg" style="height:24px; margin-right: 5px; margin-top: -5px"/>'. $this->params['sitename'] : "SeedDMS")."</a>\n";
		echo "  </div>\n";
		echo " </div>\n";
		echo "</div>\n";
	} /* }}} */
	...
	function globalNavigation($folder=null) { /* {{{ */
		...
		if(isset($this->params['user']) && $this->params['user']) {
			...
			if($this->params['enablefullsearch']) {
				echo "      <label class=\"checkbox hide\" style=\"color: #999999;\"><input type=\"checkbox\" name=\"fullsearch\" value=\"1\" title=\"".getMLText('fullsearch_hint')."\" checked=\"checked\"/> ".getMLText('fullsearch')."</label>";
			}
		...
		echo " </div>\n";
		echo "</div>\n";
		echo '<div class="container-fluid"><div class="row"><dic class="span12" style="text-align:center"><img src="/../styles/banner.png" /></div></div></div>';
		return;
	} /* }}} */
